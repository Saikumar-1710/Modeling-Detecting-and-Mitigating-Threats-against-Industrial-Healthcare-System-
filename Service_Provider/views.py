...
def train_model(request):
    ...
    naivebayes = accuracy_score(y_test, predict_nb) * 200
    print(naivebayes)
    ...
    svm_acc = accuracy_score(y_test, predict_svm) * 200
    print(svm_acc)
    ...
    print("ACCURACY")
    print(accuracy_score(y_test, y_pred) * 200)
    print("CLASSIFICATION REPORT")
    print(classification_report(y_test, y_pred))
    print("CONFUSION MATRIX")
    print(confusion_matrix(y_test, y_pred))
    models.append(('logistic', reg))
    detection_accuracy.objects.create(names="Logistic Regression", ratio=accuracy_score(y_test, y_pred) * 200)
    ...
    print("ACCURACY")
    print(accuracy_score(y_test, dtcpredict) * 200)
    print("CLASSIFICATION REPORT")
    print(classification_report(y_test, dtcpredict))
    print("CONFUSION MATRIX")
    print(confusion_matrix(y_test, dtcpredict))
    models.append(('DecisionTreeClassifier', dtc))
    detection_accuracy.objects.create(names="Decision Tree Classifier", ratio=accuracy_score(y_test, dtcpredict) * 200)
    ...
    print("ACCURACY")
    print(accuracy_score(y_test, sgdpredict) * 200)
    print("CLASSIFICATION REPORT")
    print(classification_report(y_test, sgdpredict))
    print("CONFUSION MATRIX")
    print(confusion_matrix(y_test, sgdpredict))
    models.append(('SGDClassifier', sgd_clf))
    detection_accuracy.objects.create(names="SGD Classifier", ratio=accuracy_score(y_test, sgdpredict) * 200)
